...
var SearchButton = React.createClass({
    ...
    render:function(){
        return(
            ...
            <button type="button" onClick={this.onsubmit} value="Submit" >Submit
            </button>
            {/* <a href={"#list"}>navigate</a> */}
          </form>
        );
    }
});
...
var HomePage = React.createClass({
    render: function () {
        return (
            <div>
            <Header text="Employee Directory" back="true"/>
 ...
 var App = React.createClass({
    ...
    componentDidMount:function(){
         router.addRoute('',function(){
            this.setState({page: <SearchButton/>})
        }.bind(this));
